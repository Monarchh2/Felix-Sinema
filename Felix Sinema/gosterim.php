...
if (!isset($_GET['film_id'])) {
    header('Location: index.php'); // Eğer 'film_id' GET parametresi tanımlanmamışsa, kullanıcıyı 'index.php' sayfasına yönlendir
}

$film_id = $_GET['film_id']; // 'film_id' GET parametresini al ve 'film_id' değişkenine ata

// Veritabanı sorgusu için SQL ifadesini oluştur
$sql = "SELECT 
...
$where = ' WHERE so_gosterim.tarih >= DATE(NOW()) AND so_gosterim.film_id=' . $film_id; // Sorgunun WHERE koşulunu oluştur
